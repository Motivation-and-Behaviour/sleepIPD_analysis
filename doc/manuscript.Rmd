...
sleep_outcomes_by_PA <- lapply(model_list[sleep_names], function(x){
tab <- format_table(x$table)  
tab
})

names(sleep_outcomes_by_PA) <- gsub("scale_", "", names(sleep_outcomes_by_PA)) |> 
  gsub("\\sby.*", "", x = _ ) |> 
  gsub("_", " ", x = _ ) |> 
  stringr::str_to_sentence()

  papaja::apa_table(sleep_outcomes_by_PA,
